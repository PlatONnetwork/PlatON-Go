...
var (
	...
	ErrPledgeLockFundsAmountLessThanZero = common.NewBizError(304008, "pledge lock funds amount can't less than or equal to 0")
	ErrReturnLockFundsAmountLessThanZero = common.NewBizError(304009, "return lock funds amount can't less than or equal to 0")
	ErrSlashingAmountLessThanZero        = common.NewBizError(304010, "slashing amount can't less than 0")
	ErrCreatePlanAmountLessThanZero      = common.NewBizError(304011, "create plan each amount can't less than or equal to 0")
