...
var (
	...
	ErrWrongBlsPubKeyProof       = common.NewBizError(301001, "The bls public key proof is wrong")
	...
	ErrWithdrewDelegateVonTooLow = common.NewBizError(301108, "Withdrew delegate von is too low")
	ErrDelegateNoExist           = common.NewBizError(301109, "This is delegate is not exist")
	ErrWrongVonOptType           = common.NewBizError(301110, "The von operationType is wrong")
	...
	ErrDelegateVonNoEnough       = common.NewBizError(301113, "The von of delegate is not enough")
	ErrWrongWithdrewDelVonCalc   = common.NewBizError(301114, "Withdrew delegate von calculate is wrong")
	...
	ErrWrongSlashType            = common.NewBizError(301117, "The slash type is wrong")
	ErrSlashVonOverflow          = common.NewBizError(301118, "Slash amount is overflow")
	ErrWrongSlashVonCalc         = common.NewBizError(301119, "Slash candidate von calculate is wrong")
