...
func (tp *TextProposal) GetProposer() enode.ID {
	return tp.Proposer
}
...
func (vp *VersionProposal) GetProposer() enode.ID {
	return vp.Proposer
}
...
func (cp *CancelProposal) GetProposer() enode.ID {
	return cp.Proposer
}
...
func (pp *ParamProposal) GetProposer() enode.ID {
	return pp.Proposer
}
