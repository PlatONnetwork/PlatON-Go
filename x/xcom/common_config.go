...
//
//
//type params.GovernanceConfig struct {
...
//}
//
//type params.RewardConfig struct {
...
//	Common      params.CommonConfig      `json:"common"`
//	Staking     params.StakingConfig     `json:"staking"`
//	Slashing    params.SlashingConfig    `json:"slashing"`
//	Gov         params.GovernanceConfig  `json:"gov"`
//	Reward      params.RewardConfig      `json:"reward"`
//	Restricting params.RestrictingConfig `json:"restricting"`
//	InnerAcc    params.InnerAccount      `json:"innerAcc"`
//}
//
//// When the chain is started, if new parameters are added, add them to this structure
//type params.EconomicModelExtend struct {
//	Staking params.StakingConfigExtend `json:"staking"`
//}
//
//type params.StakingConfigExtend struct {
...
//var (
//	modelOnce sync.Once
//	ec        *params.EconomicModel
//	ece       *params.params.EconomicModelExtend
//)
//
//// Getting the global EconomicModel single instance
//func GetEc(netId int8) *params.EconomicModel {
//	modelOnce.Do(func() {
...
//}
//
//func GetEce() *params.params.EconomicModelExtend {
//	return ece
//}
//
//func ResetEconomicDefaultConfig(newEc *params.EconomicModel) {
//	ec = newEc
//}
//
//func ResetEconomicExtendConfig(newEc *params.params.EconomicModelExtend) {
//	ece = newEc
//}
//
...
//)
//
//func getDefaultEMConfig(netId int8) *params.EconomicModel {
//	var (
//		ok            bool
...
//			},
//			Slashing: params.SlashingConfig{
...
//			},
//			Restricting: params.RestrictingConfig{
//				MinimumRelease: new(big.Int).Mul(one, new(big.Int).SetInt64(100)),
//			},
//			InnerAcc: params.InnerAccount{
...
//			},
//		}
//		ece = &params.EconomicModelExtend{
//			Staking: params.StakingConfigExtend{
...
//				params.StakingConfig:       ec.Staking,
//				params.StakingConfigExtend: ece.Staking,
//			},
//		}
