...
func CheckEconomicModel() error {
	...
	if err := CheckUnDelegateFreezeDuration(int(ec.Staking.UnDelegateFreezeDuration)); nil != err {
		return err
	}
...
func UnDelegateFreezeDuration() uint64 {
	return ec.Staking.UnDelegateFreezeDuration
}
