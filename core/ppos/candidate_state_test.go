...
func TestGetDefeat(t *testing.T) {
	...
	/** test WithdrawCandidate */
	t.Log("test WithdrawCandidate ...")
	ok1 := candidatePool.WithdrawCandidate(state, discover.MustHexID("0x01234567890121345678901123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345"), big.NewInt(110000000000000), new(big.Int).SetUint64(uint64(10)))
	t.Log("error", ok1)
