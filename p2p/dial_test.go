...
func TestDialStateDynDial(t *testing.T) {
	...
	runDialTest(t, dialtest{
		init: newDialState(enode.ID{}, fakeTable{}, 5, config,75),
		rounds: []round{
...
func TestDialStateDynDialBootnode(t *testing.T) {
	...
	runDialTest(t, dialtest{
		init: newDialState(enode.ID{}, table, 5, config,75),
		rounds: []round{
...
func TestDialStateDynDialFromTable(t *testing.T) {
	...
	runDialTest(t, dialtest{
		init: newDialState(enode.ID{}, table, 10, &Config{Logger: testlog.Logger(t, log.LvlTrace)},75),
		rounds: []round{
...
func TestDialStateNetRestrict(t *testing.T) {
	...
	runDialTest(t, dialtest{
		init: newDialState(enode.ID{}, table, 10, &Config{NetRestrict: restrict}, 75),
		rounds: []round{
			{
				new: []task{
...
func TestDialStateStaticDial(t *testing.T) {
	...
	runDialTest(t, dialtest{
		init: newDialState(enode.ID{}, fakeTable{}, 0, config,75),
		rounds: []round{
...
func TestDialResolve(t *testing.T) {
	...
	state := newDialState(enode.ID{}, table, 0, config,75)
