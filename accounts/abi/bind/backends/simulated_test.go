...
func TestSimulatedBackend(t *testing.T) {
	...
	auth, _ := bind.NewKeyedTransactorWithChainID(key, params.AllEthashProtocolChanges.PIP7ChainID)
	...
	tx, _ = types.SignTx(tx, types.LatestSignerForChainID(params.AllEthashProtocolChanges.PIP7ChainID), key)
...
func TestNewAdjustTimeFail(t *testing.T) {
	...
	signedTx, err := types.SignTx(tx, types.LatestSignerForChainID(params.AllEthashProtocolChanges.PIP7ChainID), testKey)
	if err != nil {
	...
	signedTx2, err := types.SignTx(tx2, types.LatestSignerForChainID(params.AllEthashProtocolChanges.PIP7ChainID), testKey)
	if err != nil {
		t.Errorf("could not sign tx: %v", err)
	}
...
func TestTransactionByHash(t *testing.T) {
	...
	tx := types.NewTransaction(uint64(0), testAddr, big.NewInt(1000), params.TxGas, gasPrice, nil)
	signedTx, err := types.SignTx(tx, types.LatestSignerForChainID(sim.config.PIP7ChainID), testKey)
	if err != nil {
		t.Errorf("could not sign tx: %v", err)
	}
...
func TestEstimateGas(t *testing.T) {
	...
	opts, _ := bind.NewKeyedTransactorWithChainID(key, params.AllEthashProtocolChanges.PIP7ChainID)
...
func TestPendingCodeAt(t *testing.T) {
	...
	auth, _ := bind.NewKeyedTransactorWithChainID(testKey, sim.config.PIP7ChainID)
...
func TestPendingAndCallContract(t *testing.T) {
	...
	contractAuth, _ := bind.NewKeyedTransactorWithChainID(testKey, sim.config.PIP7ChainID)
