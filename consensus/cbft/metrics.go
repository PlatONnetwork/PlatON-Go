...
func (rw *meteredMsgReadWriter) ReadMsg() (p2p.Msg, error) {
	...
	case msg.Code == ViewChangeVoteMsg:
		packets, traffic = propViewChangeVoteInPacketsMeter, propViewChangeVoteInTrafficMeter
	...
	case msg.Code == ConfirmedPrepareBlockMsg:
		packets, traffic = propConfirmedPrepareBlockInPacketsMeter, propConfirmedPrepareBlockInTrafficMeter
	...
	case msg.Code == HighestPrepareBlockMsg:
		packets, traffic = reqHighestPrepareBlockInPacketsMeter, reqHighestPrepareBlockInTrafficMeter
