...
public class Guessing extends Contract {
    ...
    public RemoteCall<TransactionReceipt> averageAmount() {
    ...
    public RemoteCall<TransactionReceipt> baseUnit() {
        final Function function = new Function(
                FUNC_BASEUNIT, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<TransactionReceipt> block_hash() {
        final Function function = new Function(
                FUNC_BLOCK_HASH, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<TransactionReceipt> createAddress() {
        final Function function = new Function(
                FUNC_CREATEADDRESS, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<TransactionReceipt> draw(byte[] _block_hash) {
        final Function function = new Function(
                FUNC_DRAW, 
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.generated.Bytes32(_block_hash)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> endBlock() {
        final Function function = new Function(
                FUNC_ENDBLOCK, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<TransactionReceipt> generateBlockHash(BigInteger _blocknumber) {
        final Function function = new Function(
    ...
    public RemoteCall<TransactionReceipt> getEndBlockHash() {
        final Function function = new Function(
                FUNC_GETENDBLOCKHASH, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> getMyGuessCodes() {
        final Function function = new Function(
                FUNC_GETMYGUESSCODES, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> getPostfix() {
        final Function function = new Function(
                FUNC_GETPOSTFIX, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<TransactionReceipt> getWinnerAddresses() {
        final Function function = new Function(
                FUNC_GETWINNERADDRESSES, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> getWinnerCount() {
        final Function function = new Function(
                FUNC_GETWINNERCOUNT, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<TransactionReceipt> guessingClosed() {
        final Function function = new Function(
                FUNC_GUESSINGCLOSED, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<TransactionReceipt> gussingerCodes(String param0, BigInteger param1) {
        final Function function = new Function(
                FUNC_GUSSINGERCODES, 
    ...
    public RemoteCall<TransactionReceipt> gussingerLat(String param0) {
        final Function function = new Function(
                FUNC_GUSSINGERLAT, 
                Arrays.<Type>asList(new Address(param0)),
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<TransactionReceipt> indexKey() {
        final Function function = new Function(
                FUNC_INDEXKEY, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<TransactionReceipt> indexOfgussinger(BigInteger param0) {
        final Function function = new Function(
                FUNC_INDEXOFGUSSINGER, 
                Arrays.<Type>asList(new Uint256(param0)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> postfix() {
        final Function function = new Function(
                FUNC_POSTFIX, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<TransactionReceipt> winnerAddresses(BigInteger param0) {
        final Function function = new Function(
                FUNC_WINNERADDRESSES, 
                Arrays.<Type>asList(new Uint256(param0)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> winnerMap(String param0) {
        final Function function = new Function(
                FUNC_WINNERMAP, 
                Arrays.<Type>asList(new Address(param0)),
                Collections.<TypeReference<?>>emptyList());
