...
public class DataLocation extends Contract {
    ...
    public RemoteCall<TransactionReceipt> getPerson(BigInteger _id) {
        final Function function = new Function(
                FUNC_GETPERSON, 
    ...
    public RemoteCall<TransactionReceipt> savePerson(BigInteger _id, String _name, BigInteger _age) {
        final Function function = new Function(
                FUNC_SAVEPERSON, 
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.generated.Uint256(_id), 
                new com.alaya.abi.solidity.datatypes.Utf8String(_name), 
                new com.alaya.abi.solidity.datatypes.generated.Uint256(_age)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> testBytes(byte[] _data) {
        final Function function = new Function(
                FUNC_TESTBYTES, 
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.DynamicBytes(_data)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
