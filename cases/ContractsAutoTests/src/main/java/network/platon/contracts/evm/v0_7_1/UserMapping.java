...
public class UserMapping extends Contract {
    ...
    public RemoteCall<TransactionReceipt> getOutUser(BigInteger _id) {
    ...
    public RemoteCall<TransactionReceipt> setOutUser(BigInteger _age, BigInteger _id) {
        final Function function = new Function(
                FUNC_SETOUTUSER, 
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.generated.Uint256(_age), 
                new com.alaya.abi.solidity.datatypes.generated.Uint256(_id)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
