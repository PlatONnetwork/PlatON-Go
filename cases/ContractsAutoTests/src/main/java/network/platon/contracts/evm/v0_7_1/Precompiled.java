...
public class Precompiled extends Contract {
    ...
    public RemoteCall<TransactionReceipt> callBigModExp(byte[] base, byte[] exponent, byte[] modulus) {
        final Function function = new Function(
                FUNC_CALLBIGMODEXP, 
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.generated.Bytes32(base), 
                new com.alaya.abi.solidity.datatypes.generated.Bytes32(exponent), 
                new com.alaya.abi.solidity.datatypes.generated.Bytes32(modulus)), 
    ...
    public RemoteCall<TransactionReceipt> callBn256Add(BigInteger ax, BigInteger ay, BigInteger bx, BigInteger by) {
        final Function function = new Function(
                FUNC_CALLBN256ADD, 
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.generated.Uint256(ax), 
                new com.alaya.abi.solidity.datatypes.generated.Uint256(ay), 
                new com.alaya.abi.solidity.datatypes.generated.Uint256(bx), 
                new com.alaya.abi.solidity.datatypes.generated.Uint256(by)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> callBn256Pairing(byte[] input) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.DynamicBytes(input)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> callBn256ScalarMul(byte[] x, byte[] y, byte[] scalar) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.generated.Bytes32(x), 
                new com.alaya.abi.solidity.datatypes.generated.Bytes32(y), 
                new com.alaya.abi.solidity.datatypes.generated.Bytes32(scalar)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> callRipemd160(byte[] data) {
        final Function function = new Function(
                FUNC_CALLRIPEMD160, 
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.DynamicBytes(data)), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<TransactionReceipt> callSha256(byte[] data) {
        final Function function = new Function(
                FUNC_CALLSHA256, 
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.DynamicBytes(data)), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<TransactionReceipt> getCallBigModExpValue() {
        final Function function = new Function(
                FUNC_GETCALLBIGMODEXPVALUE, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> getCallBn256AddValues() {
        final Function function = new Function(
    ...
    public RemoteCall<TransactionReceipt> getCallBn256PairingValue() {
        final Function function = new Function(
                FUNC_GETCALLBN256PAIRINGVALUE, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> getCallBn256ScalarMulValues() {
        final Function function = new Function(
                FUNC_GETCALLBN256SCALARMULVALUES, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> getCallDatacopyValue() {
        final Function function = new Function(
                FUNC_GETCALLDATACOPYVALUE, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
