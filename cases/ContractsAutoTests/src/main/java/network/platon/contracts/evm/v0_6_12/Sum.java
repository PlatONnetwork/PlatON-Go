...
public class Sum extends Contract {
    ...
    public RemoteCall<TransactionReceipt> sumUsingInlineAssembly(List<BigInteger> _data) {
        final Function function = new Function(
                FUNC_SUMUSINGINLINEASSEMBLY, 
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.DynamicArray<com.alaya.abi.solidity.datatypes.generated.Uint256>(
                com.alaya.abi.solidity.datatypes.generated.Uint256.class,
                        com.alaya.abi.solidity.Utils.typeMap(_data, com.alaya.abi.solidity.datatypes.generated.Uint256.class))), 
