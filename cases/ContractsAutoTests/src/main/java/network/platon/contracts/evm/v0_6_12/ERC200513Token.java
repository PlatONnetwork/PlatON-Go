...
public class ERC200513Token extends Contract {
    ...
    public static RemoteCall<ERC200513Token> deploy(Web3j web3j, Credentials credentials, GasProvider contractGasProvider, Long chainId, BigInteger initialSupply, String tokenName, String tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new Uint256(initialSupply),
                new com.alaya.abi.solidity.datatypes.Utf8String(tokenName), 
                new com.alaya.abi.solidity.datatypes.Utf8String(tokenSymbol)));
    ...
    public RemoteCall<TransactionReceipt> getAllowance(String _owner, String _spender) {
        final Function function = new Function(
                FUNC_GETALLOWANCE, 
    ...
    public RemoteCall<TransactionReceipt> getBalanceOf(String _owner) {
        final Function function = new Function(
                FUNC_GETBALANCEOF, 
                Arrays.<Type>asList(new Address(_owner)),
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<TransactionReceipt> getDecimals() {
        final Function function = new Function(
                FUNC_GETDECIMALS, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<TransactionReceipt> getSymbol() {
        final Function function = new Function(
                FUNC_GETSYMBOL, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
