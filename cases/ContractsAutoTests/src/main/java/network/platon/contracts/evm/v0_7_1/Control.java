...
public class Control extends Contract {
    ...
    public RemoteCall<TransactionReceipt> doWhileControlResult() {
        final Function function = new Function(
                FUNC_DOWHILECONTROLRESULT, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> forBreakControlResult() {
        final Function function = new Function(
                FUNC_FORBREAKCONTROLRESULT, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> forContinueControlResult() {
        final Function function = new Function(
                FUNC_FORCONTINUECONTROLRESULT, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> forControlResult() {
        final Function function = new Function(
    ...
    public RemoteCall<TransactionReceipt> forReturnControlResult() {
        final Function function = new Function(
                FUNC_FORRETURNCONTROLRESULT, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> forThreeControlControlResult() {
        final Function function = new Function(
                FUNC_FORTHREECONTROLCONTROLRESULT, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> getForBreakControlResult() {
        final Function function = new Function(
    ...
    public RemoteCall<TransactionReceipt> getForContinueControlResult() {
        final Function function = new Function(
                FUNC_GETFORCONTINUECONTROLRESULT, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> getForControlResult() {
        final Function function = new Function(
                FUNC_GETFORCONTROLRESULT, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> getForReturnControlResult() {
        final Function function = new Function(
    ...
    public RemoteCall<TransactionReceipt> getForThreeControlControlResult() {
        final Function function = new Function(
                FUNC_GETFORTHREECONTROLCONTROLRESULT, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> getIfControlResult() {
        final Function function = new Function(
    ...
    public RemoteCall<TransactionReceipt> getdoWhileResult() {
        final Function function = new Function(
    ...
    public RemoteCall<TransactionReceipt> ifControl(BigInteger age) {
        final Function function = new Function(
                FUNC_IFCONTROL, 
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.generated.Uint256(age)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> ifControlResult() {
        final Function function = new Function(
                FUNC_IFCONTROLRESULT, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
