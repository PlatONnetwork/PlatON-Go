...
public class Instructions extends Contract {
    ...
    public RemoteCall<TransactionReceipt> getChainId() {
    ...
    public RemoteCall<TransactionReceipt> getSelfBalance() {
        final Function function = new Function(
                FUNC_GETSELFBALANCE, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteCall<TransactionReceipt> multiply(BigInteger x, BigInteger y) {
        final Function function = new Function(
                FUNC_MULTIPLY, 
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.generated.Uint256(x), 
                new com.alaya.abi.solidity.datatypes.generated.Uint256(y)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
