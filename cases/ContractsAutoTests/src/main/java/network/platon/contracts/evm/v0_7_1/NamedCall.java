...
public class NamedCall extends Contract {
    ...
    public RemoteCall<TransactionReceipt> exchange(BigInteger key, BigInteger value) {
        final Function function = new Function(
                FUNC_EXCHANGE, 
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.generated.Uint256(key), 
                new com.alaya.abi.solidity.datatypes.generated.Uint256(value)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> namecall() {
        final Function function = new Function(
                FUNC_NAMECALL, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
