...
public class StringmappingSupport extends Contract {
    ...
    public RemoteCall<TransactionReceipt> getByte32mapValue(byte[] _key) {
    ...
    public RemoteCall<TransactionReceipt> getStringmapValue(String _key) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.Utf8String(_key)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setByte32mapValue(byte[] _key, String _value) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.generated.Bytes9(_key), 
                new com.alaya.abi.solidity.datatypes.Utf8String(_value)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
