...
public class BubbleSort extends Contract {
    ...
    public RemoteCall<TransactionReceipt> BubbleArrays(List<BigInteger> arr, BigInteger n) {
        final Function function = new Function(
                FUNC_BUBBLEARRAYS, 
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.DynamicArray<com.alaya.abi.solidity.datatypes.generated.Int256>(
                com.alaya.abi.solidity.datatypes.generated.Int256.class,
                        com.alaya.abi.solidity.Utils.typeMap(arr, com.alaya.abi.solidity.datatypes.generated.Int256.class)), 
                new com.alaya.abi.solidity.datatypes.generated.Uint256(n)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> get_arr() {
        final Function function = new Function(
                FUNC_GET_ARR, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
