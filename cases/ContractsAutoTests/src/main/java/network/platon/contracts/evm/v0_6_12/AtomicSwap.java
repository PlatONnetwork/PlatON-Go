...
public class AtomicSwap extends Contract {
    ...
    public RemoteCall<TransactionReceipt> initiate(byte[] _hashedSecret, String _participant, BigInteger _refundTimestamp, BigInteger _payoff) {
        final Function function = new Function(
                FUNC_INITIATE, 
                Arrays.<Type>asList(new Bytes32(_hashedSecret),
    ...
    public RemoteCall<TransactionReceipt> swaps(byte[] param0) {
        final Function function = new Function(
                FUNC_SWAPS, 
