...
public class MappingArrayDataTypeContract extends Contract {
    ...
    public RemoteCall<TransactionReceipt> getValueByKey(BigInteger key) {
        final Function function = new Function(
                FUNC_GETVALUEBYKEY, 
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.generated.Uint8(key)), 
    ...
    public RemoteCall<TransactionReceipt> set(BigInteger key, BigInteger value_a1, BigInteger value_a2, BigInteger value_b1, BigInteger value_b2) {
        final Function function = new Function(
                FUNC_SET, 
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.generated.Uint8(key), 
                new com.alaya.abi.solidity.datatypes.generated.Uint8(value_a1), 
                new com.alaya.abi.solidity.datatypes.generated.Uint8(value_a2), 
                new com.alaya.abi.solidity.datatypes.generated.Uint8(value_b1), 
                new com.alaya.abi.solidity.datatypes.generated.Uint8(value_b2)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
