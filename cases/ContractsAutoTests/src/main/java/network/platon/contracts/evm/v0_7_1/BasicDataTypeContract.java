...
public class BasicDataTypeContract extends Contract {
    ...
    public RemoteCall<TransactionReceipt> addIntOverflow(BigInteger a) {
        final Function function = new Function(
                FUNC_ADDINTOVERFLOW, 
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.generated.Int8(a)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> addUintOverflow(BigInteger a) {
        final Function function = new Function(
                FUNC_ADDUINTOVERFLOW, 
                Arrays.<Type>asList(new com.alaya.abi.solidity.datatypes.generated.Uint8(a)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteCall<TransactionReceipt> getBytes1Length() {
        final Function function = new Function(
    ...
    public RemoteCall<TransactionReceipt> getBytesLength() {
        final Function function = new Function(
                FUNC_GETBYTESLENGTH, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
