...
import network.platon.contracts.AbstractContractESubclass;
...
public class AbstractContractCInhertTest extends ContractPrepareTest {
   ...
   private String name,resultName;
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "AbstractContract.抽象合约继承抽象合约执行情况")
