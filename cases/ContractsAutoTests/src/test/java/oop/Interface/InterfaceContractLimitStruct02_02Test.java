 ...
 **/
public class InterfaceContractLimitStruct02_02Test extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "02InterfaceContractLimitTest.在5.0以后版本，接口可以声明结构体")
