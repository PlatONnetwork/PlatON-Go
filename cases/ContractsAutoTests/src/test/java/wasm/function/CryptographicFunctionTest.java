...
//            collector.assertEqual(publicKey,wasmAddress1.getAddress());
//
//            //platon_ripemd160
//            WasmAddress wasmAddress = cryptographicFunction.call_platon_ripemd160(DataChangeUtil.stringToBytes32("hellow")).send();
//            collector.logStepPass("call_platon_ripemd160函数返回值:" + wasmAddress.getAddress());
//
//            //platon_sha256
