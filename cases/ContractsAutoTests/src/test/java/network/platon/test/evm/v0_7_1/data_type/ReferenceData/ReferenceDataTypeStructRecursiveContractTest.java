...
import network.platon.contracts.evm.v0_7_1.ReferenceDataTypeStructRecursiveContract;
...
public class ReferenceDataTypeStructRecursiveContractTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "ReferenceDataTypeStructRecursive.结构体嵌套递归",sourcePrefix = "evm/0.7.1")
