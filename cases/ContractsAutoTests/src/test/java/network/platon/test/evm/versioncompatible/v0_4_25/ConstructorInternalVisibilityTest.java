...
import network.platon.contracts.evm.ConstructorInternalVisibility;
...
public class ConstructorInternalVisibilityTest extends ContractPrepareTest {
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "Sheet1",
            author = "albedo", showName = "network.platon.test.evm.ConstructorInternalVisibilityTest-构造函数和可见性", sourcePrefix = "evm")
