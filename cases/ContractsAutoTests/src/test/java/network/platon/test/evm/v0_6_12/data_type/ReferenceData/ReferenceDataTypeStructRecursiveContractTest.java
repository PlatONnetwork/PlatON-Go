...
import network.platon.contracts.evm.v0_6_12.ReferenceDataTypeStructRecursiveContract;
...
public class ReferenceDataTypeStructRecursiveContractTest extends ContractPrepareTest {
    ...
    @Test
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", author = "qudong", showName = "ReferenceDataTypeStructRecursive.结构体嵌套递归",sourcePrefix = "evm/0.6.12")
