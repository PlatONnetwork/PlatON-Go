...
import network.platon.contracts.evm.SameNameConstructorDefaultVisibility;
...
public class SameNameConstructorDefaultVisibilityTest extends ContractPrepareTest {
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "testSameNameConstructorVisibility",
            author = "albedo", showName = "network.platon.test.evm.SameNameConstructorDefaultVisibilityTest-同名函数未声明可见性构造函数", sourcePrefix = "evm")
