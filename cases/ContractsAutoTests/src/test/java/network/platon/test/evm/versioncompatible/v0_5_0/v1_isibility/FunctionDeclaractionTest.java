...
import network.platon.contracts.evm.FunctionDeclaraction;
...
public class FunctionDeclaractionTest extends ContractPrepareTest {
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test1.xls", sheetName = "Sheet1",
            author = "hudenian", showName = "network.platon.test.evm.version_compatible.0.5.0.FunctionDeclaractionTest-update_public-可见性测试", sourcePrefix = "evm")
