package network.platon.test.evm.versioncompatible.v0_5_13.v1_librayUseMapping;
...
public class UserLibUseMappingTest extends ContractPrepareTest {
    ...
    @DataSource(type = DataSourceType.EXCEL, file = "test.xls", sheetName = "Sheet1",
            author = "hudenian", showName = "network.platon.test.evm.UserLibUseMappingTest-允许public和external库函数的参数和返回变量使用mapping类型", sourcePrefix = "evm")
