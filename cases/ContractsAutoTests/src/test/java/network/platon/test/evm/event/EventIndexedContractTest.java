    ...
    public void testTwoDimensionalArray() {
        try {
            ...
            try {
                ...
                collector.assertEqual(e.getCause().getMessage(),"org.web3j.abi.datatypes.generated.StaticArray2<org.web3j.abi.network.platon.test.datatypes.generated.Uint256>");
            }
        } catch (Exception e) {
