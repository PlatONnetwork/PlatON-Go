...
def test_POP_001_003(client_consensus, client_new_node):
    ...
    result = client_new_node.staking.create_staking(0, address, address, amount=179000000000000000000000)
    log.info(result)
    assert_code(result, 301100)
    result = client_new_node.staking.create_staking(0, address, address, amount=1800000000000000000000000)
    log.info(result)
...
def test_POP_002(client_consensus, client_new_node, new_genesis_env):
    ...
    address, _ = client_new_node.economic.account.generate_account(client_new_node.node.web3,
                                                                   10 ** 18 * 10000000)
    result = client_new_node.staking.create_staking(0, address, address, amount=990000000000000000000000)
    log.info(result)
    assert_code(result, 301100)
    result = client_new_node.staking.create_staking(0, address, address, amount=1000000000000000000000000)
    log.info(result)
    assert_code(result, 0)


@pytest.mark.P2
def test_POP_005(client_consensus, client_new_node, new_genesis_env):
    """
...
@pytest.mark.P2
def test_POP_006(client_consensus, client_new_node, new_genesis_env):
    """
    ...
    address2, _ = client_new_node.economic.account.generate_account(client_new_node.node.web3,
                                                                    10 ** 18 * 10000000)
    result = client_new_node.delegate.delegate(0, address2, amount=10000000000000000000)
    assert_code(result, 301105)
    result = client_new_node.delegate.delegate(0, address2, amount=11000000000000000000)
    assert_code(result, 0)
    result = client_new_node.staking.increase_staking(0, address1, amount=10000000000000000000)
    assert_code(result, 301104)
    result = client_new_node.staking.increase_staking(0, address1, amount=11000000000000000000)
    assert_code(result, 0)


@pytest.mark.P2
def test_POP_007(client_consensus, client_new_node, new_genesis_env):
    """
...
def test_POP_008(client_consensus, client_new_node, new_genesis_env):
    ...
    address2, _ = client_new_node.economic.account.generate_account(client_new_node.node.web3,
                                                                    10 ** 18 * 10000000)
    result = client_new_node.delegate.delegate(0, address2, amount=13000000000000000000)
    assert_code(result, 301105)
    result = client_new_node.delegate.delegate(0, address2, amount=14000000000000000000)
    assert_code(result, 0)
    result = client_new_node.staking.increase_staking(0, address1, amount=13000000000000000000)
    assert_code(result, 301104)
    result = client_new_node.staking.increase_staking(0, address1, amount=14000000000000000000)
    assert_code(result, 0)
...
@pytest.mark.P2
def test_POP_010_011(client_consensus, client_new_node, new_genesis_env):
    """
...
@pytest.mark.P2
def test_POP_012(client_consensus, client_new_node, new_genesis_env):
    """
    :param client_consensus_obj:
    :param client_new_node_obj:
    :param new_genesis_env:
...
def test_POP_013(client_consensus, client_new_node, new_genesis_env):
    ...
    log.info(result)
    assert_code(result, 301105)
    result = client_new_node.delegate.delegate(0, address2, amount=20000000000000000000)
    assert_code(result, 0)
    result = client_new_node.staking.increase_staking(0, address1, amount=10000000000000000000)
    assert_code(result, 301104)
    result = client_new_node.staking.increase_staking(0, address1, amount=20000000000000000000)
    assert_code(result, 0)


@pytest.mark.P2
def test_POP_014(client_consensus, client_new_node, new_genesis_env):
    """
...
def test_POP_015(client_consensus, clients_noconsensus, new_genesis_env):
    ...
    address, _ = clients_noconsensus[0].economic.account.generate_account(clients_noconsensus[0].node.web3,
                                                                          10 ** 18 * 10000000)
    result = clients_noconsensus[0].staking.create_staking(0, address, address, amount=1600000000000000000000000)
    assert_code(result, 0)
    block = param_governance_verify_before_endblock(client_consensus, "staking", "maxValidators",
                                                    "6")
    wait_block_number(clients_noconsensus[1].node, block)
    address1, _ = clients_noconsensus[1].economic.account.generate_account(clients_noconsensus[1].node.web3,
                                                                           10 ** 18 * 10000000)
    result = clients_noconsensus[1].staking.create_staking(0, address1, address1, amount=1700000000000000000000000)
    assert_code(result, 0)

    clients_noconsensus[1].economic.wait_settlement_blocknum(clients_noconsensus[1].node)
    getVerifierList = get_pledge_list(clients_noconsensus[1].node.ppos.getVerifierList)
    log.info(getVerifierList)
    assert len(getVerifierList) == 6
    node_id_1 = clients_noconsensus[0].node.node_id
    node_id_2 = clients_noconsensus[1].node.node_id
