...
#     global_test_env.cfg.append_cmd = "--pprof --pprofaddr 0.0.0.0"
#     global_test_env.deploy_all()
#     test_node = global_test_env.get_all_nodes()[0]
#     print(test_node.url)
#     for node in global_test_env.get_all_nodes()[1:]:
#         node.stop()
#     from_address = "0x2e95E3ce0a54951eB9A99152A6d5827872dFB4FD"
#     tmp_from_address = test_node.web3.toChecksumAddress(from_address)
#     nonce = test_node.eth.getTransactionCount(tmp_from_address)
#     while True:
#         try:
#             nonce += 1
#             sendTransaction(test_node.web3, nonce, tmp_from_address)
