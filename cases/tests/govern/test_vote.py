...
class TestVoteVP:
    ...
    def test_V_STA_2_to_5(self, no_vp_proposal, client_verifier_obj_list):
        pip = no_vp_proposal
        value = len(client_verifier_obj_list) - 2
        submitvpandvote(client_verifier_obj_list[:value], votingrounds=3)
        proposalinfo = pip.get_effect_proposal_info_of_vote()
        log.info('Get version proposal information : {}'.format(proposalinfo))
        result = version_proposal_vote(client_verifier_obj_list[-2].pip)
        ...
        pip = client_verifier_obj_list[-1].pip
...
class TestVoteNodeException:
    ...
    def test_VO_TER_002_004(self, no_vp_proposal, client_candidate_obj, client_verifier_obj_list):
        ...
        ver_pip = client_verifier_obj_list[0].pip
    ...
    @pytest.mark.P1
    def test_VO_TER_001_003_005(self, candidate_has_proposal, client_verifier_obj):
        pip = candidate_has_proposal
        pip_test = client_verifier_obj.pip
...
class TestCadidateVote:
    ...
    def test_VO_TER_003_VO_TER_007_VO_TER_005_PP_VO_013(self, no_vp_proposal, client_candidate_obj, client_verifier_obj):
        ca_pip = client_candidate_obj.pip
        ve_pip = client_verifier_obj.pip
